...
from core.apiDetalleVenta import getAllDetVentas
...
class reportePDF(object):
    ...
    def _encabezadoPiePagina(canvas, archivoPDF):
        ...
        # Encabezado
        encabezadoNombre = Paragraph("musicPro", estilos["Normal"])
        ...
        # Pie de página
        piePagina = Paragraph("Reporte generado por musicPro.", estilos["Normal"])
    ...
    def Exportar(self):
        ...
        archivoPDF = SimpleDocTemplate(self.nombrePDF, leftMargin=50, rightMargin=50, pagesize=letter,
                                       title="Reporte PDF", author="Brandon Sepulveda")
