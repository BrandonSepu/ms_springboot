...
public class bodegaController {
    ...
    public String loadInBodega(@RequestBody bodegaModel newBodPro) {
    ...
    public void updateBodega(@RequestBody bodegaModel bodCreated) {
